                      ...
                      let uu____2994 =
                        let uu____2997 =
                          let uu____2998 =
                            ...
                            FStar_All.pipe_left
                              (fun _0_46  ->
                                 FStar_Extraction_ML_Syntax.MLE_Const _0_46)
                              uu____2999 in
                          FStar_All.pipe_left
                            (FStar_Extraction_ML_Syntax.with_ty
                               FStar_Extraction_ML_Syntax.ml_int_ty)
       ...
       | FStar_Syntax_Syntax.Tm_app
           ({
              FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_constant
                (FStar_Const.Const_reflect uu____5921);
              FStar_Syntax_Syntax.pos = uu____5922;
              FStar_Syntax_Syntax.vars = uu____5923;_},uu____5924)
           -> failwith "Unreachable? Tm_app Const_reflect"
       | FStar_Syntax_Syntax.Tm_app (head1,uu____5952::(v1,uu____5954)::[])
           when (FStar_Syntax_Util.is_fstar_tactics_embed head1) && false ->
           let uu____5995 =
             let uu____5998 = FStar_Syntax_Print.term_to_string v1 in
           ...
           let s =
             let uu____6000 =
               let uu____6001 =
                 let uu____6002 =
                   let uu____6005 = FStar_Util.marshal v1 in
                   FStar_Util.bytes_of_string uu____6005 in
                 FStar_Extraction_ML_Syntax.MLC_Bytes uu____6002 in
               FStar_Extraction_ML_Syntax.MLE_Const uu____6001 in
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_string_ty uu____6000 in
           let zero1 =
             FStar_Extraction_ML_Syntax.with_ty
               FStar_Extraction_ML_Syntax.ml_int_ty
           ...
           (uu____6025, FStar_Extraction_ML_Syntax.E_PURE, term_ty)
       | FStar_Syntax_Syntax.Tm_app (head1,args) ->
           let is_total rc =
             (FStar_Ident.lid_equals rc.FStar_Syntax_Syntax.residual_effect
               ...
               (FStar_All.pipe_right rc.FStar_Syntax_Syntax.residual_flags
                  (FStar_List.existsb
                     (fun uu___176_6057  ->
                        match uu___176_6057 with
                        | FStar_Syntax_Syntax.TOTAL  -> true
                        | uu____6058 -> false))) in
           let uu____6059 =
             let uu____6064 =
               let uu____6065 = FStar_Syntax_Subst.compress head1 in
               uu____6065.FStar_Syntax_Syntax.n in
             ((head1.FStar_Syntax_Syntax.n), uu____6064) in
           (match uu____6059 with
            | (FStar_Syntax_Syntax.Tm_uvar uu____6074,uu____6075) ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    FStar_TypeChecker_Normalize.Iota;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6093,FStar_Syntax_Syntax.Tm_abs
               (bs,uu____6095,FStar_Pervasives_Native.Some rc)) when
                is_total rc ->
                let t1 =
                  FStar_TypeChecker_Normalize.normalize
                    [FStar_TypeChecker_Normalize.Beta;
                    ...
                    g.FStar_Extraction_ML_UEnv.tcenv t in
                term_as_mlexpr' g t1
            | (uu____6116,FStar_Syntax_Syntax.Tm_constant
               (FStar_Const.Const_reify )) ->
                let e =
                  let uu____6118 = FStar_List.hd args in
                  FStar_TypeChecker_Util.reify_body_with_arg
                    g.FStar_Extraction_ML_UEnv.tcenv head1 uu____6118 in
                let tm =
                  let uu____6128 =
                    let uu____6129 = FStar_TypeChecker_Util.remove_reify e in
                    let uu____6130 = FStar_List.tl args in
                    FStar_Syntax_Syntax.mk_Tm_app uu____6129 uu____6130 in
                  uu____6128 FStar_Pervasives_Native.None
                    t.FStar_Syntax_Syntax.pos in
                term_as_mlexpr' g tm
            | uu____6139 ->
                let rec extract_app is_data uu____6184 uu____6185 restArgs =
                  match (uu____6184, uu____6185) with
                       ...
                       | ([],uu____6275) ->
                                               ...
                                               let uu____6484 =
                                                 FStar_All.pipe_left
                                                   ...
                                                   (FStar_Extraction_ML_Syntax.MLE_Var
                                                      x) in
                                               uu____6484 :: out_args in
                                             (((x, arg) :: lbs), uu____6481)))
                                 ([], []) mlargs_f in
                           (match uu____6298 with
                            | (lbs,mlargs) ->
                                ...
                                (l_app, f, t1))
                       | ((arg,uu____6567)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (formal_t,f',t2)) when
                           (is_type g arg) &&
                             (type_leq g formal_t
                                FStar_Extraction_ML_Syntax.ml_unit_ty)
                           ...
                           extract_app is_data
                             (mlhead,
                               ((FStar_Extraction_ML_Syntax.ml_unit,
                                  FStar_Extraction_ML_Syntax.E_PURE) ::
                               mlargs_f)) uu____6598 rest
                       | ((e0,uu____6615)::rest,FStar_Extraction_ML_Syntax.MLTY_Fun
                          (tExpected,f',t2)) ->
                           let r = e0.FStar_Syntax_Syntax.pos in
                           let uu____6647 = term_as_mlexpr g e0 in
                ...
                let extract_app_maybe_projector is_data mlhead uu____6750
                  args1 =
                  match uu____6750 with
                  | (f,t1) ->
                      (match is_data with
                       | FStar_Pervasives_Native.Some
                           (FStar_Syntax_Syntax.Record_projector uu____6782)
                           ->
                           let rec remove_implicits args2 f1 t2 =
                             match (args2, t2) with
                             | ((a0,FStar_Pervasives_Native.Some
                                 (FStar_Syntax_Syntax.Implicit uu____6860))::args3,FStar_Extraction_ML_Syntax.MLTY_Fun
                                (uu____6862,f',t3)) ->
                                 let uu____6899 =
                                   FStar_Extraction_ML_Util.join
                                     a0.FStar_Syntax_Syntax.pos f1 f' in
                                 remove_implicits args3 uu____6899 t3
                             | uu____6900 -> (args2, f1, t2) in
                           let uu____6925 = remove_implicits args1 f t1 in
                   ...
                   | FStar_Syntax_Syntax.Tm_fvar fv when
                       (FStar_Syntax_Syntax.fv_eq_lid fv
                         ...
                         (let uu____7011 =
                            ...
                            uu____7012 = "FStar.Tactics.Builtins" in
                       ...
                       (match args with
                        ...
                        | uu____7053 ->
                            ...
                            failwith uu____7062)
                   | FStar_Syntax_Syntax.Tm_name uu____7069 ->
                       let uu____7070 =
                         let uu____7083 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7083 with
                         | (FStar_Util.Inr (uu____7102,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7147 -> failwith "FIXME Ty" in
                       (match uu____7070 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7197)::uu____7198 -> is_type g a
                              | uu____7217 -> false in
                            let uu____7226 =
                              match vars with
                              | uu____7255::uu____7256 when
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7403 ->
                                               let uu___180_7406 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___180_7406.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___180_7406.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           ...
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___181_7411.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___181_7411.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7412 ->
                                               let uu___181_7413 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___181_7413.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___181_7413.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___182_7422 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___182_7422.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___182_7422.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                 ...
                                 (match args1 with
                                  ...
                                  | uu____7485 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | FStar_Syntax_Syntax.Tm_fvar uu____7494 ->
                       let uu____7495 =
                         let uu____7508 =
                           FStar_Extraction_ML_UEnv.lookup_term g head2 in
                         match uu____7508 with
                         | (FStar_Util.Inr (uu____7527,x1,x2,x3),q) ->
                             ((x1, x2, x3), q)
                         | uu____7572 -> failwith "FIXME Ty" in
                       (match uu____7495 with
                        | ((head_ml,(vars,t1),inst_ok),qual) ->
                            let has_typ_apps =
                              match args with
                              | (a,uu____7622)::uu____7623 -> is_type g a
                              | uu____7642 -> false in
                            let uu____7651 =
                              match vars with
                              | uu____7680::uu____7681 when
                                  (Prims.op_Negation has_typ_apps) && inst_ok
                                  -> (head_ml, t1, args)
                              | uu____7692 ->
                                  let n1 = FStar_List.length vars in
                                         ...
                                         let mk_tapp e ty_args =
                                           ...
                                           | uu____7828 ->
                                               let uu___180_7831 = e in
                                               {
                                                 ...
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   =
                                                   (uu___180_7831.FStar_Extraction_ML_Syntax.mlty);
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___180_7831.FStar_Extraction_ML_Syntax.loc)
                                               } in
                                         let head3 =
                                           match head_ml.FStar_Extraction_ML_Syntax.expr
                                           with
                                           | FStar_Extraction_ML_Syntax.MLE_Name
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___181_7836.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___181_7836.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_Var
                                               uu____7837 ->
                                               let uu___181_7838 =
                                                   ...
                                                   prefixAsMLTypes in
                                               {
                                                 FStar_Extraction_ML_Syntax.expr
                                                   =
                                                   (uu___181_7838.FStar_Extraction_ML_Syntax.expr);
                                                 FStar_Extraction_ML_Syntax.mlty
                                                   = t2;
                                                 FStar_Extraction_ML_Syntax.loc
                                                   =
                                                   (uu___181_7838.FStar_Extraction_ML_Syntax.loc)
                                               }
                                           | FStar_Extraction_ML_Syntax.MLE_App
                                               (head3,{
                                                        FStar_Extraction_ML_Syntax.expr
                                                 ...
                                                 (FStar_Extraction_ML_Syntax.MLE_App
                                                    ((let uu___182_7847 =
                                                          ...
                                                          prefixAsMLTypes in
                                                      {
                                                        FStar_Extraction_ML_Syntax.expr
                                                          =
                                                          (uu___182_7847.FStar_Extraction_ML_Syntax.expr);
                                                        FStar_Extraction_ML_Syntax.mlty
                                                          =
                                                          (FStar_Extraction_ML_Syntax.MLTY_Fun
                                                             (FStar_Extraction_ML_Syntax.ml_unit_ty,
                                                        ...
                                                        FStar_Extraction_ML_Syntax.loc
                                                          =
                                                          (uu___182_7847.FStar_Extraction_ML_Syntax.loc)
                                                      }),
                                                      [FStar_Extraction_ML_Syntax.ml_unit]))
                                                 (FStar_Extraction_ML_Syntax.with_ty
                                                    t2)
                                  ...
                                  | uu____7910 ->
                                      extract_app_maybe_projector qual
                                        ...
                                        (FStar_Extraction_ML_Syntax.E_PURE,
                                          head_t) args1)))
                   | uu____7919 ->
                       let uu____7920 = term_as_mlexpr g head2 in
                       (match uu____7920 with
                        | (head3,f,t1) ->
                            extract_app_maybe_projector
                              FStar_Pervasives_Native.None head3 (f, t1) args)))
       | FStar_Syntax_Syntax.Tm_ascribed (e0,(tc,uu____7938),f) ->
           let t1 =
             match tc with
           ...
           let uu____8005 = check_term_as_mlexpr g e0 f1 t1 in
           (match uu____8005 with | (e,t2) -> (e, f1, t2))
       | FStar_Syntax_Syntax.Tm_let ((is_rec,lbs),e') ->
           ...
           let uu____8036 =
             ...
             then FStar_Syntax_Subst.open_let_rec lbs e'
               ...
               (let uu____8050 = FStar_Syntax_Syntax.is_top_level lbs in
                if uu____8050
                then (lbs, e')
                else
                  (let lb = FStar_List.hd lbs in
                   let x =
                     ...
                     FStar_Syntax_Syntax.freshen_bv uu____8064 in
                   let lb1 =
                     let uu___183_8066 = lb in
                     {
                       FStar_Syntax_Syntax.lbname = (FStar_Util.Inl x);
                       FStar_Syntax_Syntax.lbunivs =
                         (uu___183_8066.FStar_Syntax_Syntax.lbunivs);
                       FStar_Syntax_Syntax.lbtyp =
                         (uu___183_8066.FStar_Syntax_Syntax.lbtyp);
                       FStar_Syntax_Syntax.lbeff =
                         (uu___183_8066.FStar_Syntax_Syntax.lbeff);
                       FStar_Syntax_Syntax.lbdef =
                         (uu___183_8066.FStar_Syntax_Syntax.lbdef)
                     } in
                   let e'1 =
            ...
            | (lbs1,e'1) ->
                         ...
                         (fun lb  ->
                            let tcenv =
                              ...
                              FStar_TypeChecker_Env.set_current_module
                                g.FStar_Extraction_ML_UEnv.tcenv uu____8098 in
                            FStar_Extraction_ML_UEnv.debug g
                              (fun uu____8105  ->
                            ...
                            (let lbdef =
                               let uu____8109 = FStar_Options.ml_ish () in
                               if uu____8109
                             ...
                             let uu___184_8113 = lb in
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___184_8113.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___184_8113.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___184_8113.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___184_8113.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = lbdef
                             })))
                  else lbs1 in
                let maybe_generalize uu____8136 =
                  match uu____8136 with
                  | { FStar_Syntax_Syntax.lbname = lbname_;
                      FStar_Syntax_Syntax.lbunivs = uu____8156;
                      ...
                      (match t2.FStar_Syntax_Syntax.n with
                       | FStar_Syntax_Syntax.Tm_arrow (bs,c) when
                           let uu____8226 = FStar_List.hd bs in
                           FStar_All.pipe_right uu____8226 (is_type_binder g)
                           ->
                           let uu____8239 = FStar_Syntax_Subst.open_comp bs c in
                            ...
                            | (bs1,c1) ->
                                let uu____8264 =
                                  let uu____8271 =
                                    FStar_Util.prefix_until
                                      (fun x  ->
                                         let uu____8307 = is_type_binder g x in
                                         Prims.op_Negation uu____8307) bs1 in
                                ...
                                (match uu____8264 with
                                 | (tbinders,tbody) ->
                                     ...
                                     let e1 =
                                       let uu____8440 = normalize_abs e in
                  ...
                  FStar_List.fold_right
                    (fun lb  ->
                       fun uu____9555  ->
                         ...
                         | (env,lbs4) ->
                             let uu____9680 = lb in
                             (match uu____9680 with
                              | (lbname,uu____9728,(t1,(uu____9730,polytype)),add_unit,uu____9733)
                                  ->
                                  let uu____9746 =
                ...
                (match uu____9464 with
                 | (env_body,lbs4) ->
                     ...
                     let uu____10023 = term_as_mlexpr env_body e'1 in
                              ...
                              let uu____10054 =
                                let uu____10055 =
                                  FStar_List.map FStar_Pervasives_Native.snd
                                    lbs5 in
                                (is_rec1, [], uu____10055) in
                              mk_MLE_Let top_level uu____10054 e'2 in
                            let uu____10066 =
                              FStar_Extraction_ML_Util.mlloc_of_range
                                t.FStar_Syntax_Syntax.pos in
                            FStar_Extraction_ML_Syntax.with_ty_loc t'
                              uu____10053 uu____10066 in
                          (uu____10052, f, t'))))
       | FStar_Syntax_Syntax.Tm_match (scrutinee,pats) ->
           let uu____10105 = term_as_mlexpr g scrutinee in
           (match uu____10105 with
            | (e,f_e,t_e) ->
                let uu____10121 = check_pats_for_ite pats in
                       ...
                       (match (then_e, else_e) with
                        | (FStar_Pervasives_Native.Some
                           then_e1,FStar_Pervasives_Native.Some else_e1) ->
                            let uu____10178 = term_as_mlexpr g then_e1 in
                            (match uu____10178 with
                             | (then_mle,f_then,t_then) ->
                                 let uu____10194 = term_as_mlexpr g else_e1 in
                                      ...
                                      (match uu____10210 with
                                       | (t_branch,maybe_lift1) ->
                                           let uu____10267 =
                                             ...
                                             FStar_All.pipe_left
                                               (FStar_Extraction_ML_Syntax.with_ty
                                                  t_branch) uu____10268 in
                                           let uu____10285 =
                                             FStar_Extraction_ML_Util.join
                                               then_e1.FStar_Syntax_Syntax.pos
                                               f_then f_else in
                                           (uu____10267, uu____10285,
                                             t_branch))))
                        | uu____10286 ->
                            failwith
                            ...
                            (match mlbranches1 with
                             | [] ->
                                 ...
                                 (match uu____10887 with
                                  | (uu____10956,fw,uu____10958,uu____10959)
                                      ->
                                      let uu____10960 =
                                        let uu____10961 =
                                          let uu____10962 =
                                      ...
                                      (uu____10960,
                                        FStar_Extraction_ML_Syntax.E_PURE,
                                        FStar_Extraction_ML_Syntax.ml_unit_ty))
                             | (uu____10975,uu____10976,(uu____10977,f_first,t_first))::rest
                                 ->
                                 let uu____11037 =
                                   FStar_List.fold_left
                                     (fun uu____11079  ->
                                        fun uu____11080  ->
                                          match (uu____11079, uu____11080)
                                          with
                                          | ((topt,f),(uu____11137,uu____11138,
                                                       (uu____11139,f_branch,t_branch)))
                                              ->
                                              let f1 =
                                                FStar_Extraction_ML_Util.join
    ...
    fun discName  ->
      fun constrName  ->
        let uu____11372 =
          ...
          FStar_All.pipe_left FStar_Pervasives_Native.fst uu____11377 in
        match uu____11372 with
        | (uu____11402,fstar_disc_type) ->
            let wildcards =
              let uu____11411 =
                let uu____11412 = FStar_Syntax_Subst.compress fstar_disc_type in
                uu____11412.FStar_Syntax_Syntax.n in
              match uu____11411 with
              | FStar_Syntax_Syntax.Tm_arrow (binders,uu____11422) ->
                  let uu____11439 =
                    FStar_All.pipe_right binders
                      (FStar_List.filter
                         (fun uu___177_11471  ->
                            match uu___177_11471 with
                            | (uu____11478,FStar_Pervasives_Native.Some
                               (FStar_Syntax_Syntax.Implicit uu____11479)) ->
                                true
                            | uu____11482 -> false)) in
                  FStar_All.pipe_right uu____11439
                    (FStar_List.map
                       (fun uu____11515  ->
                          let uu____11522 = fresh "_" in
                          (uu____11522, FStar_Extraction_ML_Syntax.MLTY_Top)))
              | uu____11523 -> failwith "Discriminator must be a function" in
                        ...
                        let uu____11566 =
                          let uu____11577 =
                            let uu____11586 =
                              ...
                              FStar_Extraction_ML_Syntax.MLP_CTor uu____11587 in
                            let uu____11597 =
                              FStar_All.pipe_left
                                (FStar_Extraction_ML_Syntax.with_ty
                            ...
                            (uu____11586, FStar_Pervasives_Native.None,
                              uu____11597) in
                          let uu____11600 =
                            let uu____11611 =
                              let uu____11620 =
                              ...
                              (FStar_Extraction_ML_Syntax.MLP_Wild,
                                FStar_Pervasives_Native.None, uu____11620) in
                            [uu____11611] in
                          uu____11577 :: uu____11600 in
                        (uu____11563, uu____11566) in
                      FStar_Extraction_ML_Syntax.MLE_Match uu____11548 in
                    FStar_All.pipe_left
                      (FStar_Extraction_ML_Syntax.with_ty
                         FStar_Extraction_ML_Syntax.ml_bool_ty) uu____11547 in
                  ((FStar_List.append wildcards [(mlid, targ)]), uu____11546) in
                FStar_Extraction_ML_Syntax.MLE_Fun uu____11535 in
              FStar_All.pipe_left
                (FStar_Extraction_ML_Syntax.with_ty disc_ty) uu____11534 in
            let uu____11675 =
              let uu____11676 =
                let uu____11679 =
                  let uu____11680 =
                  ...
                  {
                    FStar_Extraction_ML_Syntax.mllb_name = uu____11680;
                    FStar_Extraction_ML_Syntax.mllb_tysc =
                      FStar_Pervasives_Native.None;
                ...
                [uu____11679] in
              (FStar_Extraction_ML_Syntax.NonRec, [], uu____11676) in
            FStar_Extraction_ML_Syntax.MLM_Let uu____11675