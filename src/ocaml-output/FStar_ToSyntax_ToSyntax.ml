      ...
      fun top  ->
        ...
        | FStar_Parser_AST.Construct (n1,(a,uu____4857)::[]) when
            ...
            (FStar_Errors.warn top.FStar_Parser_AST.range
             ...
             (let uu____4873 =
                let uu___256_4874 = top in
                let uu____4875 =
                  let uu____4876 =
                    let uu____4883 =
                      let uu___257_4884 = top in
                      let uu____4885 =
                        let uu____4886 =
                          FStar_Ident.lid_of_path ["Prims"; "smt_pat"]
                            top.FStar_Parser_AST.range in
                        FStar_Parser_AST.Var uu____4886 in
                      {
                        ...
                        FStar_Parser_AST.range =
                          (uu___257_4884.FStar_Parser_AST.range);
                        FStar_Parser_AST.level =
                          (uu___257_4884.FStar_Parser_AST.level)
                      } in
                  ...
                  FStar_Parser_AST.App uu____4876 in
                {
                  ...
                  FStar_Parser_AST.range =
                    (uu___256_4874.FStar_Parser_AST.range);
                  FStar_Parser_AST.level =
                    (uu___256_4874.FStar_Parser_AST.level)
                } in
              desugar_term_maybe_top top_level env uu____4873))
        | FStar_Parser_AST.Construct (n1,(a,uu____4889)::[]) when
            n1.FStar_Ident.str = "SMTPatOr" ->
            let uu____4904 =
              let uu___258_4905 = top in
              let uu____4906 =
                let uu____4907 =
                  let uu____4914 =
                    let uu___259_4915 = top in
                    let uu____4916 =
                      let uu____4917 =
                      ...
                      FStar_Parser_AST.Var uu____4917 in
                    {
                      ...
                      FStar_Parser_AST.range =
                        (uu___259_4915.FStar_Parser_AST.range);
                      FStar_Parser_AST.level =
                        (uu___259_4915.FStar_Parser_AST.level)
                    } in
                ...
                FStar_Parser_AST.App uu____4907 in
              {
                ...
                FStar_Parser_AST.range =
                  (uu___258_4905.FStar_Parser_AST.range);
                FStar_Parser_AST.level =
                  (uu___258_4905.FStar_Parser_AST.level)
              } in
                               ...
                               | (env2,x) ->
                                   ...
                                   (env2,
                                     (FStar_List.append tparams
                                        [(((let uu___260_5464 = x in
                                            {
                                              FStar_Syntax_Syntax.ppname =
                                                (uu___260_5464.FStar_Syntax_Syntax.ppname);
                                              FStar_Syntax_Syntax.index =
                                                (uu___260_5464.FStar_Syntax_Syntax.index);
                                              FStar_Syntax_Syntax.sort = t1
                                            })),
                                           FStar_Pervasives_Native.None)]),
                                     uu____5431)))) (env, [], [])
        ...
        | FStar_Parser_AST.Product (binders,t) ->
            ...
            (match uu____5532 with
             | (bs,t1) ->
                 let rec aux env1 bs1 uu___227_5564 =
                   match uu___227_5564 with
                   | [] ->
                       let cod =
        ...
        | FStar_Parser_AST.Abs (binders,body) ->
            ...
            (match uu____5665 with
             | (uu____5726,ftv) ->
                 ...
                 let rec aux env1 bs sc_pat_opt uu___228_5779 =
                   match uu___228_5779 with
                   | [] ->
...
and desugar_formula:
  ...
  fun env  ->
    fun f  ->
      ...
      let setpos t =
        let uu___261_10504 = t in
        {
          FStar_Syntax_Syntax.n = (uu___261_10504.FStar_Syntax_Syntax.n);
          FStar_Syntax_Syntax.pos = (f.FStar_Parser_AST.range);
          FStar_Syntax_Syntax.vars =
            (uu___261_10504.FStar_Syntax_Syntax.vars)
        } in
      let desugar_quant q b pats body =
        let tk =
          desugar_binder env
            (let uu___262_10538 = b in
             {
               FStar_Parser_AST.b = (uu___262_10538.FStar_Parser_AST.b);
               FStar_Parser_AST.brange =
                 (uu___262_10538.FStar_Parser_AST.brange);
               FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
               FStar_Parser_AST.aqual =
                 (uu___262_10538.FStar_Parser_AST.aqual)
             }) in
        ...
        | (FStar_Pervasives_Native.Some a,k) ->
            ...
            (match uu____10610 with
             | (env1,a1) ->
                 let a2 =
                   let uu___263_10620 = a1 in
                   {
                     FStar_Syntax_Syntax.ppname =
                       (uu___263_10620.FStar_Syntax_Syntax.ppname);
                     FStar_Syntax_Syntax.index =
                       (uu___263_10620.FStar_Syntax_Syntax.index);
                     FStar_Syntax_Syntax.sort = k
                   } in
          ...
          (fun uu____10954  ->
             fun b  ->
               ...
               | (env1,out) ->
                   let tk =
                     desugar_binder env1
                       (let uu___264_11006 = b in
                        {
                          FStar_Parser_AST.b =
                            (uu___264_11006.FStar_Parser_AST.b);
                          FStar_Parser_AST.brange =
                            (uu___264_11006.FStar_Parser_AST.brange);
                          FStar_Parser_AST.blevel = FStar_Parser_AST.Formula;
                          FStar_Parser_AST.aqual =
                            (uu___264_11006.FStar_Parser_AST.aqual)
                        }) in
                   (match tk with
                    | (FStar_Pervasives_Native.Some a,k) ->
                        ...
                        (match uu____11023 with
                         | (env2,a1) ->
                             let a2 =
                               let uu___265_11043 = a1 in
                               {
                                 FStar_Syntax_Syntax.ppname =
                                   (uu___265_11043.FStar_Syntax_Syntax.ppname);
                                 FStar_Syntax_Syntax.index =
                                   (uu___265_11043.FStar_Syntax_Syntax.index);
                                 FStar_Syntax_Syntax.sort = k
                               } in
                             (env2,
            ...
            (match uu____11439 with
             | (formals,uu____11455) ->
                 (match formals with
                  | [] -> []
                  | uu____11478 ->
                      let filter_records uu___232_11490 =
                        match uu___232_11490 with
    ...
    fun d  ->
      fun quals  ->
        fun tcs  ->
          ...
          let tycon_id uu___233_11691 =
            match uu___233_11691 with
          ...
          let apply_binders t binders =
            ...
            FStar_List.fold_left
              ...
              binders in
          let tycon_record_as_variant uu___234_11846 =
            match uu___234_11846 with
          ...
          let desugar_abstract_tc quals1 _env mutuals uu___235_12046 =
            match uu___235_12046 with
               ...
               | (uu____12442,uu____12443,se,uu____12445) ->
                   let se1 =
                     ...
                     | FStar_Syntax_Syntax.Sig_inductive_typ
                         ...
                         let uu___266_12497 = se in
                         {
                           FStar_Syntax_Syntax.sigel =
                             (FStar_Syntax_Syntax.Sig_declare_typ (l, [], t));
                           FStar_Syntax_Syntax.sigrng =
                             (uu___266_12497.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals = quals2;
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___266_12497.FStar_Syntax_Syntax.sigmeta);
                           FStar_Syntax_Syntax.sigattrs =
                             (uu___266_12497.FStar_Syntax_Syntax.sigattrs)
                         }
    ...
    fun d  ->
      ...
      | (env1,sigelts) ->
          ...
          let uu____17315 =
            FStar_List.map
              (fun sigelt  ->
                 let uu___267_17321 = sigelt in
                 {
                   FStar_Syntax_Syntax.sigel =
                     (uu___267_17321.FStar_Syntax_Syntax.sigel);
                   FStar_Syntax_Syntax.sigrng =
                     (uu___267_17321.FStar_Syntax_Syntax.sigrng);
                   FStar_Syntax_Syntax.sigquals =
                     (uu___267_17321.FStar_Syntax_Syntax.sigquals);
                   FStar_Syntax_Syntax.sigmeta =
                     (uu___267_17321.FStar_Syntax_Syntax.sigmeta);
                       ...
                       FStar_All.pipe_right (FStar_Pervasives_Native.snd lbs)
                         (FStar_List.map
                            (fun lb  ->
                               ...
                               let uu___268_17655 = lb in
                               {
                                 FStar_Syntax_Syntax.lbname =
                                   (FStar_Util.Inr
                                      (let uu___269_17657 = fv in
                                       {
                                         FStar_Syntax_Syntax.fv_name =
                                           (uu___269_17657.FStar_Syntax_Syntax.fv_name);
                                         FStar_Syntax_Syntax.fv_delta =
                                           (FStar_Syntax_Syntax.Delta_abstract
                                              (fv.FStar_Syntax_Syntax.fv_delta));
                                         FStar_Syntax_Syntax.fv_qual =
                                           (uu___269_17657.FStar_Syntax_Syntax.fv_qual)
                                       }));
                                 FStar_Syntax_Syntax.lbunivs =
                                   (uu___268_17655.FStar_Syntax_Syntax.lbunivs);
                                 FStar_Syntax_Syntax.lbtyp =
                                   (uu___268_17655.FStar_Syntax_Syntax.lbtyp);
                                 FStar_Syntax_Syntax.lbeff =
                                   (uu___268_17655.FStar_Syntax_Syntax.lbeff);
                                 FStar_Syntax_Syntax.lbdef =
                                   (uu___268_17655.FStar_Syntax_Syntax.lbdef)
                               })) in
             ...
             | (pat,body) ->
                 ...
                 let fresh_pat =
                   ...
                   | FStar_Parser_AST.PatAscribed (pat1,ty) ->
                       let uu___270_17738 = pat1 in
                       {
                         FStar_Parser_AST.pat =
                           (FStar_Parser_AST.PatAscribed (var_pat, ty));
                         FStar_Parser_AST.prange =
                           (uu___270_17738.FStar_Parser_AST.prange)
                       }
                   | uu____17739 -> var_pat in
                 let main_let =
                   desugar_decl env
                     (let uu___271_17746 = d in
                      {
                        FStar_Parser_AST.d =
                          (FStar_Parser_AST.TopLevelLet
                             (isrec, [(fresh_pat, body)]));
                        FStar_Parser_AST.drange =
                          (uu___271_17746.FStar_Parser_AST.drange);
                        FStar_Parser_AST.doc =
                          (uu___271_17746.FStar_Parser_AST.doc);
                        FStar_Parser_AST.quals = (FStar_Parser_AST.Private ::
                          (d.FStar_Parser_AST.quals));
                        FStar_Parser_AST.attrs =
                          (uu___271_17746.FStar_Parser_AST.attrs)
                      }) in
...
let desugar_decls:
  ...
  fun env  ->
    fun decls  ->
      ...
      | (env1,sigelts) ->
          let rec forward acc uu___244_18403 =
            match uu___244_18403 with
            | se1::se2::sigelts1 ->
                (match ((se1.FStar_Syntax_Syntax.sigel),
                 ...
                 | (FStar_Syntax_Syntax.Sig_declare_typ
                    uu____18417,FStar_Syntax_Syntax.Sig_let uu____18418) ->
                     let uu____18431 =
                       let uu____18434 =
                         let uu___272_18435 = se2 in
                         let uu____18436 =
                           let uu____18439 =
                             FStar_List.filter
                               (fun uu___243_18453  ->
                                  match uu___243_18453 with
                                  | {
                                      FStar_Syntax_Syntax.n =
                                        FStar_Syntax_Syntax.Tm_app
                                        ({
                         ...
                         {
                           FStar_Syntax_Syntax.sigel =
                             (uu___272_18435.FStar_Syntax_Syntax.sigel);
                           FStar_Syntax_Syntax.sigrng =
                             (uu___272_18435.FStar_Syntax_Syntax.sigrng);
                           FStar_Syntax_Syntax.sigquals =
                             (uu___272_18435.FStar_Syntax_Syntax.sigquals);
                           FStar_Syntax_Syntax.sigmeta =
                             (uu___272_18435.FStar_Syntax_Syntax.sigmeta);
